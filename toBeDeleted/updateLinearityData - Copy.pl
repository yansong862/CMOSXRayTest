...
$inLinearityFile ="C:\\Users\\scltester\\Documents\\GitWorkspace\\FaxitronCabinet\\Linearity\\linearity.txt";
...
my $linearityExcelTemp ="C:\\CMOS\\ForReports\\Linearity Test_SerialNo.xlsx.xlsx";
### start excel application 
my $Excel = Win32::OLE->GetActiveObject('Excel.Application')
   || Win32::OLE->new('Excel.Application', 'Quit');
$Excel -> {"Visible"} = 0;
...
### copy updated linearity excel template to local
copy($linearityExcelTemp, join(src,"Linearity.xlsx"));
die;
